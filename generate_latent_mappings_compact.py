...
def main(args):
    ...
    for i in range(2):
        ...
        ax[i].errorbar(np.linspace(1, vae_size, vae_size)-0.2, mu_cover, e_cover, linestyle='None', marker='.', label='cover', capsize=cap_size, elinewidth=l_size)
        ax[i].errorbar(np.linspace(1, vae_size, vae_size)-0.1, mu_container_lsb, e_container_lsb, linestyle='None', marker='.', label='lsb container', capsize=cap_size, elinewidth=l_size)
        ax[i].errorbar(np.linspace(1, vae_size, vae_size), mu_container_ddh, e_container_ddh, linestyle='None', marker='.', label='ddh container', capsize=cap_size, elinewidth=l_size)
        ax[i].errorbar(np.linspace(1, vae_size, vae_size)+0.1, mu_container_udh, e_container_udh, linestyle='None', marker='.', label='udh container', capsize=cap_size, elinewidth=l_size)
